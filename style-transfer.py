...
def build_parser():
    ...
    parser.add_argument(
        '--checkpoint_dir',
        type=str,
        default='style-transfer/checkpoint',
        help='Checkpoint directory')

    parser.add_argument(
        '--checkpoint_path',
        type=str,
        default='style-transfer/checkpoint/ckpt_i41392',
        help='Checkpoint directory')

    parser.add_argument(
        '--style',
        type=str,
        default='style-transfer/images/styles/wave.jpg',
        help='style image path')

    parser.add_argument(
        '--train-path',
        type=str,
        default='style-transfer/data/test2017',
        help='path to training images folder')

    parser.add_argument(
        '--test',
        type=str,
        default='style-transfer/images/test/test.jpg',  # False
        help='test image path')

    parser.add_argument(
        '--test-dir',
        type=str,
        default='style-transfer/images/results',  # False
        help='test image save dir')

    parser.add_argument(
        '--vgg-path',
        type=str,
        default='style-transfer/data/imagenet-vgg-verydeep-19.mat',
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.0,
        help='the size of net')
    parser.add_argument(
        '--model_dir', type=str, default='style-transfer/model', help='Model directory.')

    parser.add_argument(
        '--model_name', type=str, default='style-transfer/style_graph', help='Model name.')
    return parser
        ...
        for epoch in range(epochs):
            for batch in range(n_batches):
                ...
                for i, img_p in enumerate(content_targets[curr:step]):
                    X_batch[i] = get_img(img_p, (256, 256,3)).astype(np.float32)
